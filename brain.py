...
class PooBrain(Brain):
    ...
    def choose_action(self, metrics, stats, world):
        ...
        if not self.moving_right and pygame.sprite.spritecollideany(left_shift, world.platforms):
            self.moving_right = True
        if self.moving_right and pygame.sprite.spritecollideany(right_shift, world.platforms):
